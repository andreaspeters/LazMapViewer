...
type
  ...
  protected
    ...
    procedure pTaskEnded({%H-}aTask: integer; aExcept: Exception); override;
    function pGetTask: integer; override;
  public
    constructor Create(aJob: TJob; aTask: integer);
    procedure ExecuteTask({%H-}aTask: integer; {%H-}FromWaiting: boolean); override;
...
var
  ...
  procedure SetRes({%H-}e: Exception);
  begin
    MyQueue.EnterCriticalSection;
    try
